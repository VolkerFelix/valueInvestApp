...
print("Total equity change")
pprint.pprint(msft.get_balancesheet().loc['TotalEquityGrossMinorityInterest'].iloc[::-1].pct_change())
print("Mean total equity change")
pprint.pprint(msft.get_balancesheet().loc['TotalEquityGrossMinorityInterest'].iloc[::-1].pct_change().mean())
print("Market cap")
...
print("Earnings forcast")
pprint.pprint(msft.get_earnings_forecast())
